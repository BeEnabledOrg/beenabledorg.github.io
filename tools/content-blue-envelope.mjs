...
const STATES = [
  ...
  { name: "Colorado", abbr: "CO", status: "local",
    ...
    chapters: [
      ...
      { where: "Jefferson County and other agencies", sponsor: "Jefferson County Sheriff's Office", launched: "2025", populations: "Communication challenges", contact: "Jefferson County Sheriff's Office", confirmed: true, sourceText: "jeffcosheriffco.gov" },
    ] },
  ...
  { name: "Maine", abbr: "ME", status: "local",
    ...
    chapters: [
      ...
      { where: "Rumford", sponsor: "Rumford Police Department", launched: "Not stated in the source", populations: "Autism", contact: "Rumford Police Department", confirmed: true, sourceText: "rumfordpd.org" },
    ] },
  ...
  { name: "New Jersey", abbr: "NJ", status: "local",
    ...
    chapters: [
      ...
      { where: "Egg Harbor Township", sponsor: "Egg Harbor Township Police Department", launched: "Not stated in the source", populations: "Autism", contact: "Egg Harbor Township Police Department", confirmed: true, sourceText: "ehtnj.gov" },
    ] },
  ...
  { name: "New York", abbr: "NY", status: "local",
    summary: "The New York State Sheriffs' Association coordinates a county-by-county rollout that has reached more than 20 counties so far, almost all run through the county Sheriff's Office.",
    chapters: [
      ...
      { where: "Suffolk County", sponsor: "Suffolk County Sheriff's Office", launched: "2024–2026", populations: "Autism spectrum disorder", contact: "Suffolk County Sheriff's Office", confirmed: true, sourceText: "suffolkcountysheriffsoffice.com" },
      { where: "Oneida County", sponsor: "Oneida County Sheriff's Office", launched: "2024–2026", populations: "Autism", contact: "Oneida County Sheriff's Office", confirmed: true, sourceText: "sheriff.oneidacountyny.gov" },
      { where: "Saratoga County", sponsor: "Saratoga County Sheriff's Office", launched: "2024–2026", populations: "Autism", contact: "sheriff@saratogacountyny.gov, subject line \"Blue Envelope Program\" — free", confirmed: true, sourceText: "cbs6albany.com" },
      { where: "Albany County", sponsor: "Albany County Sheriff's Office", launched: "2024–2026", populations: "Autism", contact: "(518) 487-5400 or contactsheriff@albanycounty.com", confirmed: true, sourceText: "dailygazette.com" },
      { where: "St. Lawrence County", sponsor: "County Sheriff's Office, with regional developmental disability advocacy networks (LifePlan CCO, ACANY)", launched: "2024–2026", populations: "Autism", contact: "County Sheriff's Office or a regional advocacy network", confirmed: true, sourceText: "sheriff.oneidacountyny.gov" },
      { where: "Dutchess County", sponsor: "Dutchess County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Sgt. Montanya, amontanya@dutchessny.gov, (845) 486-3834", confirmed: true, sourceText: "dutchessny.gov" },
      { where: "Greene County", sponsor: "Greene County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Kate Murphy, Director of Community Wellness, kmurphy@greenesheriffny.gov", confirmed: true, sourceText: "greenesheriffny.gov" },
      { where: "Madison County", sponsor: "Madison County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Madison County Sheriff's Office", confirmed: true, sourceText: "madisoncounty.ny.gov" },
      { where: "Montgomery County", sponsor: "Montgomery County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Lieutenant Justin Smith, (518) 853-5500", confirmed: true, sourceText: "montgomerycountysheriffny.com" },
      { where: "Putnam County", sponsor: "Putnam County Sheriff's Department", launched: "Not stated in the source", populations: "Autism", contact: "Putnam County Sheriff's Department", confirmed: true, sourceText: "putnamsheriff.com" },
      { where: "Rensselaer County", sponsor: "Rensselaer County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Kristine Cauwenberghs, (518) 266-1903, kcauwenberghs@rensco.com", confirmed: true, sourceText: "rensco.com" },
      { where: "Town of Clarkstown (Rockland County)", sponsor: "Clarkstown Police Department", launched: "Not stated in the source", populations: "Autism", contact: "Clarkstown Police Department", confirmed: true, sourceText: "rocklandreport.com" },
      { where: "Schenectady County", sponsor: "Schenectady County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Sheriff's substation, 130 Princetown Plaza, Princetown; or Sgt. Jeffrey Iovinelli, Jeffrey.iovinelli@schenectadycountyny.gov", confirmed: true, sourceText: "schenectadycountyny.gov" },
      { where: "Tompkins County", sponsor: "Tompkins County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Tompkins County Sheriff's Office", confirmed: true, sourceText: "tompkinscountyny.gov" },
      { where: "Washington County", sponsor: "Washington County Sheriff's Office", launched: "Not stated in the source", populations: "Autism", contact: "Law Enforcement Center, 399 Broadway, Fort Edward; (518) 746-2475 or contactsheriff@washingtoncountyny.gov", confirmed: true, sourceText: "washingtoncountyny.gov" },
    ] },
  ...
  { name: "Pennsylvania", abbr: "PA", status: "local",
    ...
    chapters: [
      ...
      { where: "Scranton", sponsor: "Scranton Police Department", launched: "Not stated in the source", populations: "Autism", contact: "Scranton Police Department", confirmed: true, sourceText: "audacy.com" },
    ] },
  ...
  body: `
    ...
    <section class="section">
      <div class="wrap wrap--narrow stack">
        ...
        <p>A blue envelope holds the driver's license, registration, and
           insurance. It also carries short tips for the officer — whether it
           is the driver or a passenger who communicates differently.</p>
        <p>Handing it over says: <strong>Someone in this car may need more
           time, and communicates differently.</strong></p>
        ...
        <ol class="steps">
          ...
          <li>
            ...
            <div>
              <strong>Keep the vehicle's documents inside</strong>
      ...
      <div class="wrap">
        ...
        <ul class="grid no-bullet">
          <li class="card">
            ...
            <form class="stack" method="post" action="https://formsubmit.co/info@beenabled.org">
              ...
              <input type="hidden" name="_subject" value="Ohio Blue Envelope waitlist signup">
              <input type="hidden" name="_template" value="table">
              <input type="hidden" name="_next" value="https://beenabled.org/blue-envelope/joined/">
              <input type="hidden" name="_captcha" value="false">
              <input type="hidden" name="_autoresponse" value="Thank you. You are on the waitlist for Ohio's Blue Envelope Program. We will send one email when it is ready, and nothing else. To leave the list, reply to this email and say so.">
