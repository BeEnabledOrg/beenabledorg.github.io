      ...
      <div class="wrap hero__inner">
        <div class="stack">
          ...
          <p class="btn-row">
            ...
            <!-- TODO(content): replace # with the real mailing list URL, once
                 there is one. See CONTENT-TODO.md and get-involved/index.html,
                 which has the same placeholder for the same reason. -->
            <a class="btn btn--secondary" href="#">Join the waitlist</a>
          </p>
